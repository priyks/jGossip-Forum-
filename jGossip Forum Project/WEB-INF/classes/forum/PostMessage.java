...
public class PostMessage extends HttpServlet implements SingleThreadModel{
	...
	throws IOException, ServletException{
		...
		if ((session.getValue("topic")!=null)&&(request.getAttribute("message")!=null)&&(session.getValue("forum")!=null)){
			topic = (Topic)session.getValue("topic");
