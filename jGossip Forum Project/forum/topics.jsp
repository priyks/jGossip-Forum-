...
<%
	if (session.getValue("forum")!=null){
      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="100%">
            ...
            <span class="text"><a href="./" class="linktext">Main Index</a> > <%=frm.getName()%></span>
            <br><br>
            <a href="jsps/newtopic.jsp" class="linktext">New Topic</a>
            <jsp:include page="./engines/topiceng.jsp" flush="true"/>
            <a href="jsps/newtopic.jsp" class="linktext">New Topic</a>
          </td width="100">
